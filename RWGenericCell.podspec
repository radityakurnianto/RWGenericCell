#
# Be sure to run `pod lib lint RWGenericCell.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
RWGenericCell is a helper tool to register, dequeue cell within UITableView, UICollectionView
                       DESC
  ...
  s.source_files = 'RWGenericCell/Classes/**/*'
  
  # s.resource_bundles = {
  #   'RWGenericCell' => ['RWGenericCell/Assets/*.png']
  # }
